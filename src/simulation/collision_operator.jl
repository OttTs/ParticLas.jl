...
function calculate_relaxation_parameters!(mesh, species, time_step)
    ...
    ω, m, Tᵣ, ωᵣ, μᵣ = species.weighting, species.mass, species.ref_temperature, species.ref_exponent, species.ref_viscosity
